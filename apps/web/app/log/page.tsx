...
export default function LogPage() {
  ...
  return (
    <main className="min-h-screen bg-warm-50 px-4 py-6 space-y-6 max-w-lg mx-auto">

      {/* ── Page title ── */}
      <header className="flex items-center justify-between">
        <h1 className="section-title">Log Food</h1>
        <span className="text-sm text-warm-400">Today</span>
      </header>
